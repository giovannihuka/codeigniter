<table cellpadding="0" cellspacing="0" border="0" class="display groceryCrudTable" id="<?php echo uniqid(); ?>">
	<thead>
		<tr>
<!-- 			<th width="20">
				<div class="text-left field_sorting">#</div>
				<div class="text-left">#</div>
			</th> -->
			<?php foreach($columns as $column){?>
				<!-- <th style="text-align: center;"><?php echo $column->display_as; ?></th> -->
				<th <?php echo ( isset($column->style_string) && $column->style_string != "" ) ? 
					'style="'.$column->style_string.'"' : '';?>>
	...
	<tbody>
		...
		<tr id='row-<?php echo $num_row?>'>
			<!-- <td class="text-right"><?php echo ($num_row + 1);?></td> -->
			<?php foreach($columns as $column){?>
				<!-- <td><?php echo $row->{$column->field_name}?></td> -->
				<td <?php echo ( isset($column->style_string) && $column->style_string != "" ) ? 
					'style="'.$column->style_string.'"' : '';?>>
