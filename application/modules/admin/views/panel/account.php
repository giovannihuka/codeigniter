...
<div class="row">
	...
	<div class="col-md-6">
		<div class="box box-primary">
			...
			<div class="box-body">
				<?php echo $form1->open(); ?>
					<?php echo $form1->bs3_text('Username', 'username', $user->username,'readonly'); ?>
					<?php echo $form1->bs3_text('First Name', 'first_name', $user->first_name); ?>
					<!-- <?php echo $form1->bs3_text('Middle Name', 'middle_name', $user->middle_name); ?> -->
					<?php echo $form1->bs3_text('Last Name', 'last_name', $user->last_name); ?>
					<!-- <?php echo $form1->bs3_color('Color Code','color',$user->color); ?> -->
