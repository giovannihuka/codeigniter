    ...
    <div class="col-md-6">
        <div class="box box-primary">
            <div class="box-body">
				...
				<?php echo $form->bs3_dropdown('Status Grosir','company_status','',$contract['company_status'],'','Pilih Status Grosir'); ?>
				...
				<?php echo $form->bs3_dropdown('Status Data','status_data','',$contract['status_data'],'','Pilih Status Data'); ?>
