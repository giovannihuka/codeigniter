...
$string .= "\n\t\t\t<td style=\"text-align:center\" width=\"80px\">"
        . "\n\t\t\t\t<?php "
        . "\n\t\t\t\techo anchor(site_url('admin/".$c_url."/read/'.$".$c_url."->".$pk."),'<i class=\'fa fa-eye\'></i>'); "
        . "\n\t\t\t\techo '&nbsp&nbsp'; "
        . "\n\t\t\t\techo anchor(site_url('admin/".$c_url."/update/'.$".$c_url."->".$pk."),'<i class=\'fa fa-pencil-square-o\'></i>'); "
        . "\n\t\t\t\techo '&nbsp&nbsp'; "
        . "\n\t\t\t\techo anchor(site_url('admin/".$c_url."/delete/'.$".$c_url."->".$pk."),'<i class=\'fa fa-trash-o\'></i>','onclick=\"javasciprt: return confirm(\\'Anda yakin ?\\')\"'); "
        . "\n\t\t\t\t?>"
        . "\n\t\t\t</td>";
