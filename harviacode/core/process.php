...
{
    $additional_field_time = array('create_time','update_time');
    $additional_field_id = array('create_userid','update_userid');
    $additional_update_id = array('update_userid');
    $additional_update_time = array('update_time');
    ...
    if ($table_name <> '')
    {
        ...
        $js_target = $get_setting->js_target;
        ...
        $title = $hc->table_title($table_name);
        $f_with_default = $hc->non_pk_with_default($table_name);
        foreach ($f_with_default as $row) {
        ...
        $hasil[] = $hasil_pdf;
        // $hasil[] = '../assets/dist/admin/'.$hasil_js;
        $hasil[] = $hasil_js;
    } else
    {
